        ...
        <Box sx={{ minHeight: '100vh', pb: 8 }}>
            ...
            <Grid container spacing={3} sx={{ mb: 4 }}>
                <Grid item xs={12} sm={6} md={2.4}>
                    <StatCard label="Total Anomalies" value={anomalies.length} icon={Timeline} color="primary.main" />
                </Grid>
                <Grid item xs={12} sm={6} md={2.4}>
                    <StatCard label="Critical" value={criticalCount} icon={Warning} color="error.main" />
                </Grid>
                <Grid item xs={12} sm={6} md={2.4}>
                    <StatCard label="High Priority" value={highCount} icon={TrendingUp} color="warning.main" />
                </Grid>
                <Grid item xs={12} sm={6} md={2.4}>
                    <StatCard label="Correlations" value={correlations.length} subValue={`${causalCount} causal`} icon={Hub} color="secondary.main" />
                </Grid>
                <Grid item xs={12} sm={6} md={2.4}>
                    <StatCard label="Pending Review" value={unreviewedCount} icon={AccessTime} color="info.main" />
                </Grid>
            </Grid>
